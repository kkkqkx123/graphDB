...
| bincode                                            | oxicode                                              |
| -------------------------------------------------- | ---------------------------------------------------- |
| `use bincode::{encode_to_vec, decode_from_slice};` | `use oxicode::{encode_to_vec, decode_from_slice};`   |
| `use bincode::{Decode, Encode};`                   | `use oxicode::{Decode, Encode};`                     |
...
// After (oxicode)
let result: Result<T, oxicode::Error> = decode_from_slice(bytes);
```
