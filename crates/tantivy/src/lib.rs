...
pub use crate::index::{
    Bm25Params, Index, IndexBuilder, IndexMeta, IndexSettings, InvertedIndexReader, Order, Segment,
...
pub mod tests {
    ...
    fn test_wrong_fast_field_type() -> crate::Result<()> {
        ...
        let segment_reader: &SegmentReader = searcher.segment_reader(0);
        {
            ...
            assert!(fast_field_reader_res.is_none());
        }
        {
...

        {
            ...
            assert!(fast_field_reader_res.is_some());
