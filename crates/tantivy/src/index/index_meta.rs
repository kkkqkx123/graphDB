...
///
/// The default values (k1=1.8, b=0.4) are optimized for code search scenarios where
/// exact identifier matching is prioritized over general text relevance.
#[derive(Clone, Debug, Serialize, Deserialize, PartialEq)]
pub struct Bm25Params {
    /// Term frequency saturation parameter (default: 1.8)
    ///
    /// Higher values increase the impact of term frequency.
    /// For code search, higher k1 (1.5-2.0) improves exact identifier matching.
    /// Typical range: 1.0 to 2.0
    pub k1: Score,
    /// Length normalization parameter (default: 0.4)
    ///
    /// Lower values reduce the impact of document length normalization.
    /// For code search, lower b (0.3-0.6) prevents short entities from being penalized.
