...
- Line 72: unused variable: `index`: help: if this is intentional, prefix it with an underscore: `_index`
- Line 345: function `create_test_vertex` is never used
...
- Line 20: ambiguous glob re-exports: the name `IndexStatus` in the type namespace is first re-exported here
