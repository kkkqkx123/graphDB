...
- **Unique Warning Patterns**: 97
- **Files with Issues**: 84
...
- Line 339: unused variable: `node`: help: if this is intentional, prefix it with an underscore: `_node`
- Line 144: unused variable: `context`: help: if this is intentional, prefix it with an underscore: `_context`
- Line 233: unused variable: `expr`: help: if this is intentional, prefix it with an underscore: `_expr`
- ... 1 more occurrences in this file
