...
- `src\query\visitor\plan_node_visitor.rs`: 4 warnings
...
- Line 37: field `thread_pool` is never read
- ... 1 more occurrences in this file

#### `src\query\visitor\plan_node_visitor.rs`: 4 occurrences
...
- Line 556: value assigned to `last_changes` is never read
- Line 659: unused variable: `node_id`: help: if this is intentional, prefix it with an underscore: `_node_id`
- Line 637: unused variable: `root_group`: help: if this is intentional, prefix it with an underscore: `_root_group`
