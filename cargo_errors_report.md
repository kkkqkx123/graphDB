...
- Line 6: unused imports: `AggregateFunction` and `BinaryOperator`
- Line 7: unused import: `ExpressionErrorType`
- Line 451: associated functions `eval_like_operation`, `like_to_regex`, and `like_simple_match` are never used
