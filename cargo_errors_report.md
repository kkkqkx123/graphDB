...
- **error[E0599]**: 60 errors
- **error[E0308]**: 55 errors
- **error[E0046]**: 50 errors
- **error[E0433]**: 50 errors
- **error[E0560]**: 23 errors
...
- `src\query\executor\cypher\clauses\match_path\expression_evaluator.rs`: 39 errors
- `src\query\optimizer\prune_properties_visitor.rs`: 26 errors
- `src\query\optimizer\optimizer.rs`: 12 errors
- `src\cache\parser_cache.rs`: 11 errors
- `src\query\parser\statements\create_impl.rs`: 10 errors
- `src\query\executor\cypher\clauses\match_path\traversal_engine.rs`: 7 errors
...
### error[E0599]: no method named `save_schema_changes_to_disk` found for reference `&schema_manager_impl::MemorySchemaManager` in the current scope
...
#### `src\query\executor\cypher\clauses\match_executor.rs`: 2 occurrences

- Line 386: no variant or associated item named `Literal` found for enum `expr::Expr` in the current scope: variant or associated item not found in `expr::Expr`
- Line 423: no variant or associated item named `Literal` found for enum `expr::Expr` in the current scope: variant or associated item not found in `expr::Expr`
...
### error[E0308]: mismatched types: expected `Option<Expr>`, found `Vec<PropertyDef>`
...
- Line 260: mismatched types: expected `VariableExpr`, found `String`

### error[E0433]: failed to resolve: could not find `cypher` in `parser`: could not find `cypher` in `parser`

**Total Occurrences**: 50  
**Unique Files**: 5

#### `src\query\executor\cypher\clauses\match_path\expression_evaluator.rs`: 39 occurrences

- Line 111: failed to resolve: could not find `cypher` in `parser`: could not find `cypher` in `parser`
- Line 114: failed to resolve: could not find `cypher` in `parser`: could not find `cypher` in `parser`
- Line 239: failed to resolve: could not find `cypher` in `parser`: could not find `cypher` in `parser`
- ... 36 more occurrences in this file

#### `src\query\executor\cypher\clauses\match_path\traversal_engine.rs`: 7 occurrences

- Line 193: failed to resolve: could not find `cypher` in `parser`: could not find `cypher` in `parser`
- Line 279: failed to resolve: could not find `cypher` in `parser`: could not find `cypher` in `parser`
- Line 177: failed to resolve: could not find `cypher` in `parser`: could not find `cypher` in `parser`
- ... 4 more occurrences in this file

#### `src\query\executor\cypher\clauses\match_executor.rs`: 2 occurrences

- Line 386: failed to resolve: could not find `Literal` in `expr`: could not find `Literal` in `expr`
- Line 423: failed to resolve: could not find `Literal` in `expr`: could not find `Literal` in `expr`
...
- Line 428: failed to resolve: could not find `cypher` in `parser`: could not find `cypher` in `parser`
...
### error[E0560]: struct `token::Token` has no field named `token_type`: `token::Token` does not have this field
...
#### `src\cache\parser_cache.rs`: 9 occurrences

- Line 466: struct `token::Token` has no field named `token_type`: `token::Token` does not have this field
- Line 467: struct `token::Token` has no field named `value`: `token::Token` does not have this field
- Line 468: struct `token::Token` has no field named `position`: `token::Token` does not have this field
- ... 6 more occurrences in this file

#### `src\query\executor\cypher\factory.rs`: 3 occurrences

- Line 252: struct `stmt::CreateStmt` has no field named `patterns`: `stmt::CreateStmt` does not have this field
- Line 260: struct `stmt::DeleteStmt` has no field named `expressions`: `stmt::DeleteStmt` does not have this field
- Line 261: struct `stmt::DeleteStmt` has no field named `detach`: `stmt::DeleteStmt` does not have this field

### error[E0609]: no field `items` on type `&expr::ListExpr`: unknown field
...
### error[E0063]: missing fields `direction`, `dst`, `src` and 1 other field in initializer of `stmt::CreateTarget`: missing `direction`, `dst`, `src` and 1 other field
...
### error[E0432]: unresolved import `crate::query::parser::parser`: could not find `parser` in `parser`
...
- Line 11: unresolved import `crate::query::parser::lexer::TokenType`: no `TokenType` in `query::parser::lexer`
...
- Line 7: expected one of `::`, `;`, or `as`, found `match_path`: expected one of `::`, `;`, or `as`
...
### error[E0583]: file not found for module `expression_evaluator`
...
- Line 16: file not found for module `expression_evaluator`
...
### warning: unused variable: `var_name`: help: if this is intentional, prefix it with an underscore: `_var_name`
