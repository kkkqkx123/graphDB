...
- Line 180: mismatched types: expected `u32`, found `u8`
- Line 181: mismatched types: expected `u32`, found `u8`
- Line 205: mismatched types: expected `i32`, found `i16`

### error[E0422]: cannot find struct, variant or union type `Date` in this scope: not found in this scope

**Total Occurrences**: 2  
**Unique Files**: 1

#### `src\index\binary.rs`: 2 occurrences

- Line 358: cannot find struct, variant or union type `Date` in this scope: not found in this scope
- Line 372: cannot find struct, variant or union type `DateTime` in this scope: not found in this scope

## Detailed Warning Categorization

### warning: unexpected `cfg` condition value: `system_monitor`
...
- Line 315: unused imports: `DateTimeValue`, `DateValue`, and `TimeValue`
...
- Line 120: unused variable: `start_column`: help: if this is intentional, prefix it with an underscore: `_start_column`
- Line 1036: variable does not need to be mutable
- Line 1050: variable does not need to be mutable
...
#### `src\index\stats.rs`: 1 occurrences

- Line 223: variable does not need to be mutable
