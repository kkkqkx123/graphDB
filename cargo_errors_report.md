...
- `src\query\planner\statements\path_planner.rs`: 2 warnings
- `src\query\executor\graph_query_executor.rs`: 2 warnings

## Detailed Warning Categorization

### warning: unused variable: `config`: help: if this is intentional, prefix it with an underscore: `_config`
