...
- `src\query\parser\parser\stmt_parser.rs`: 6 warnings
...
#### `src\query\parser\parser\stmt_parser.rs`: 6 occurrences

- Line 7: unused import: `crate::query::parser::ast::expr::*`
- Line 8: unused import: `crate::query::parser::ast::pattern::*`
...
- Line 332: unused variable: `n`: help: if this is intentional, prefix it with an underscore: `_n`
- Line 343: unused variable: `n`: help: if this is intentional, prefix it with an underscore: `_n`
- Line 365: unused variable: `b`: help: if this is intentional, prefix it with an underscore: `_b`
