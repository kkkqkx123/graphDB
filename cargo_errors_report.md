...
- Line 328: unused variable: `property`: help: if this is intentional, prefix it with an underscore: `_property`
- Line 485: function cannot return without recursing: cannot return without recursing
...
- Line 1111: associated function `find_group_by_id_mut` is never used

#### `src\query\optimizer\plan_validator.rs`: 3 occurrences

- Line 439: unused import: `crate::api::session::session_manager::SessionInfo`
- Line 441: unused import: `OptGroup`
- Line 444: function `create_test_context` is never used
...
- Line 842: unreachable pattern: no value can reach this
...
- Line 650: unreachable pattern: no value can reach this
...
- Line 363: unused imports: `ListExpr`, `MapExpr`, `PathExpr`, `PropertyAccessExpr`, `RangeExpr`, and `SubscriptExpr`
