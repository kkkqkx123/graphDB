...
- `tests\integration_fulltext_advanced.rs`: 2 warnings
...
- `tests\integration_sync.rs`: 1 warnings
- `src\vector\embedding.rs`: 1 warnings
- `src\query\optimizer\heuristic\join_optimization\index_join_selection.rs`: 1 warnings
...
### warning: manual `!RangeInclusive::contains` implementation: help: use: `!(0.0..=1.0).contains(&threshold)`
...
- Line 122: method `build_col_names` is never used
- Line 395: method `build_col_names` is never used
- Line 175: this expression creates a reference which is immediately dereferenced by the compiler: help: change this to: `field`
...
- Line 87: useless use of `vec!`: help: you can use an array directly: `[left_str, right_str]`
- ... 1 more occurrences in this file
...
- Line 218: manual `!RangeInclusive::contains` implementation: help: use: `!(0.0..=1.0).contains(&threshold)`

#### `src\query\optimizer\heuristic\join_optimization\join_elimination.rs`: 2 occurrences

- Line 78: this expression creates a reference which is immediately dereferenced by the compiler: help: change this to: `left`
- Line 78: this expression creates a reference which is immediately dereferenced by the compiler: help: change this to: `right`

#### `src\query\planning\plan\core\nodes\data_access\vector_search.rs`: 2 occurrences

- Line 34: this function has too many arguments (10/7)
- Line 114: this function has too many arguments (9/7)

#### `tests\integration_fulltext_advanced.rs`: 2 occurrences

- Line 476: unused variable: `vertex`: help: if this is intentional, prefix it with an underscore: `_vertex`
- Line 112: length comparison to one: help: using `!is_empty` is clearer and more explicit: `!results.is_empty()`

#### `tests\integration_sync.rs`: 1 occurrences

- Line 959: field assignment outside of initializer for an instance created with Default::default()

#### `src\query\optimizer\heuristic\join_optimization\index_join_selection.rs`: 1 occurrences
...
- Line 113: this `if` has identical blocks
