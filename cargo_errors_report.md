...
- Line 759: variable does not need to be mutable
...
#### `src\core\value.rs`: 2 occurrences

- Line 310: unreachable pattern: no value can reach this
- Line 481: method `hash_value` is never used
