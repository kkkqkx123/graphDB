...
- `src\query\planner\statements\clauses\where_clause_planner.rs`: 3 warnings
...
- Line 17: field `schema_tree` is never read
- Line 113: method `value_from_bytes` is never used
