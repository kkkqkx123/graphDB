...
- **Total Warnings**: 58
- **Total Issues**: 293
- **Unique Error Patterns**: 47
- **Unique Warning Patterns**: 26
...
- `src\query\planner\statements\clauses\with_clause_planner.rs`: 6 warnings
...
- Line 329: mismatched types: expected `Vec<ContextualExpression>`, found `Vec<Expression>`
- Line 330: mismatched types: expected `Vec<ContextualExpression>`, found `Vec<Expression>`
...
- Line 655: mismatched types: expected `Expression`, found `ContextualExpression`
...
#### `src\query\planner\statements\clauses\with_clause_planner.rs`: 6 occurrences

- Line 423: unused variable: `object`
- Line 451: unused variable: `collection`
- Line 465: unused variable: `collection`
- ... 3 more occurrences in this file
