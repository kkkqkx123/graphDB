#[cfg(test)]
mod tests {
    use super::super::fulltext::{ChangeType, FulltextCoordinator};
    ...
    async fn test_coordinator_multiple_indexes() {
        ...
        coordinator
            .create_index(1, "Post", "title", None)
            .await
        ...
        let title_results = coordinator
            .search(1, "Post", "title", "Rust", 10)
            .await
            .expect("Failed to search title");
        let content_results = coordinator
            .search(1, "Post", "content", "programming", 10)
            .await
    ...
    async fn test_coordinator_vertex_delete() {
        ...
        // Verify exists
        let results = coordinator
            .search(1, "Article", "title", "Deleted", 10)
            .await
            .expect("Failed to search");
    ...
    async fn test_coordinator_list_indexes() {
        ...
        coordinator
            ...
            .expect("Failed to create index");
        coordinator
            .create_index(2, "Post", "title", None)
            .await
            .expect("Failed to create index");
    ...
    async fn test_coordinator_multiple_spaces() {
        ...
        coordinator
            .create_index(1, "Article", "title", None)
            .await
            .expect("Failed to create index in space 1");
        coordinator
            .create_index(2, "Article", "title", None)
            .await
            .expect("Failed to create index in space 2");
        ...
        // Search in space 1
        let results = coordinator
            .search(1, "Article", "title", "Space", 10)
            .await
        ...
        // Search in space 2
        let results = coordinator
            .search(2, "Article", "title", "Space", 10)
            .await
