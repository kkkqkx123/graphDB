...
impl OperatorRegistry {
    ...
    pub fn get_binary_operators(&self) -> Vec<&BinaryOperator> {
        self.operators.iter().filter_map(|op| {
...
impl Operator for UnaryOperator {
    ...
    fn precedence(&self) -> u8 {
        match self {
            ...
            UnaryOperator::Not | UnaryOperator::Increment | UnaryOperator::Decrement => 9,
            
            // 存在性检查操作符
            UnaryOperator::IsNull | UnaryOperator::IsNotNull |
            UnaryOperator::IsEmpty | UnaryOperator::IsNotEmpty => 3,
        }
    }
    ...
    fn is_left_associative(&self) -> bool {
        match self {
            ...
            UnaryOperator::IsEmpty | UnaryOperator::IsNotEmpty => false,
...
impl UnaryOperator {
    ...
    pub fn category(&self) -> OperatorCategory {
        match self {
            ...
            UnaryOperator::IsNull | UnaryOperator::IsNotNull |
            UnaryOperator::IsEmpty | UnaryOperator::IsNotEmpty => OperatorCategory::Comparison,
...
impl AggregateFunction {
    ...
    pub fn is_collection(&self) -> bool {
        matches!(self, AggregateFunction::Count | AggregateFunction::Collect | 
