...
pub enum Expression {
    ...
    // 属性相关表达式
    TagProperty { tag: String, prop: String },            // tagName.propName
    EdgeProperty { edge: String, prop: String },          // edgeName.propName
    InputProperty(String),                                // $-.propName
    VariableProperty { var: String, prop: String },       // $varName.propName
    SourceProperty { tag: String, prop: String },         // $^.tagName.propName
    DestinationProperty { tag: String, prop: String },    // $$.tagName.propName
    ...
    // 类型转换
    TypeCasting { expr: Box<Expression>, target_type: String },
...
impl Expression {
    ...
    pub fn children(&self) -> Vec<&Expression> {
        match self {
            ...
            Expression::Reduce { list, initial, expr, .. } => vec![list.as_ref(), initial.as_ref(), expr.as_ref()],
            ...
            Expression::Subscript { collection, index } => vec![collection.as_ref(), index.as_ref()],
