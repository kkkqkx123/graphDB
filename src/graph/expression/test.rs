...
mod tests {
    ...
    fn test_unary_operations() {
        let evaluator = ExpressionEvaluator;
        let expr = Expression::UnaryNot(Box::new(Expression::Constant(Value::Bool(false))));
        let context = EvalContext::new();
    ...
    fn test_case_expression() {
        ...
        let value = Expression::Constant(Value::String("greater".to_string()));
        let default = Some(Box::new(Expression::Constant(Value::String("less".to_string()))));
