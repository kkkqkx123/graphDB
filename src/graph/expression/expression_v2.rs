...
impl Expression {
    ...
    /// 创建范围访问表达式
    pub fn range(collection: Expression, start: Option<Expression>, end: Option<Expression>) -> Self {
        Expression::Range {
            collection: Box::new(collection),
    ...
    fn test_containers() {
        ...
        assert_eq!(
            ...
            Expression::Map(vec![
                ...
                ("b".to_string(), Expression::Literal(LiteralValue::String("hello".to_string()))),
            ])
        );
    }
