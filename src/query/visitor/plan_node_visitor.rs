...
pub trait PlanNodeVisitor {
    ...
    /// 访问索引扫描节点
    fn visit_index_scan(&mut self, node: &crate::query::planner::plan::algorithms::IndexScan) -> Self::Result;

    /// 访问全文索引扫描节点
    fn visit_fulltext_index_scan(&mut self, node: &crate::query::planner::plan::algorithms::FulltextIndexScan) -> Self::Result;
    ...
    /// 访问多源最短路径节点
    fn visit_multi_shortest_path(&mut self, node: &crate::query::planner::plan::algorithms::MultiShortestPath) -> Self::Result;

    /// 访问 BFS 最短路径节点
    fn visit_bfs_shortest(&mut self, node: &crate::query::planner::plan::algorithms::BFSShortest) -> Self::Result;

    /// 访问所有路径节点
    fn visit_all_paths(&mut self, node: &crate::query::planner::plan::algorithms::AllPaths) -> Self::Result;

    /// 访问最短路径节点
    fn visit_shortest_path(&mut self, node: &crate::query::planner::plan::algorithms::ShortestPath) -> Self::Result;
...
impl PlanNodeVisitor for DefaultPlanNodeVisitor {
    ...
    fn visit_get_edges(&mut self, _node: &GetEdgesNode) {}
    fn visit_get_neighbors(&mut self, _node: &GetNeighborsNode) {}
    fn visit_scan_vertices(&mut self, _node: &ScanVerticesNode) {}
    fn visit_scan_edges(&mut self, _node: &ScanEdgesNode) {}
    fn visit_index_scan(&mut self, _node: &crate::query::planner::plan::algorithms::IndexScan) {}
    fn visit_fulltext_index_scan(&mut self, _node: &crate::query::planner::plan::algorithms::FulltextIndexScan) {}
    ...
    fn visit_hash_left_join(&mut self, _node: &HashLeftJoinNode) {}
    fn visit_aggregate(&mut self, _node: &AggregateNode) {}
    fn visit_argument(&mut self, _node: &ArgumentNode) {}
    fn visit_loop(&mut self, _node: &LoopNode) {}
    fn visit_pass_through(&mut self, _node: &PassThroughNode) {}
    fn visit_select(&mut self, _node: &SelectNode) {}
    fn visit_data_collect(&mut self, _node: &DataCollectNode) {}
    ...
    fn visit_multi_shortest_path(&mut self, _node: &crate::query::planner::plan::algorithms::MultiShortestPath) {}
    fn visit_bfs_shortest(&mut self, _node: &crate::query::planner::plan::algorithms::BFSShortest) {}
    fn visit_all_paths(&mut self, _node: &crate::query::planner::plan::algorithms::AllPaths) {}
    fn visit_shortest_path(&mut self, _node: &crate::query::planner::plan::algorithms::ShortestPath) {}
    ...
    fn visit_show_spaces(&mut self, _node: &ShowSpacesNode) {}
    fn visit_create_tag(&mut self, _node: &CreateTagNode) {}
    fn visit_alter_tag(&mut self, _node: &AlterTagNode) {}
    fn visit_desc_tag(&mut self, _node: &DescTagNode) {}
    fn visit_drop_tag(&mut self, _node: &DropTagNode) {}
    fn visit_show_tags(&mut self, _node: &ShowTagsNode) {}
    fn visit_create_edge(&mut self, _node: &CreateEdgeNode) {}
    fn visit_alter_edge(&mut self, _node: &AlterEdgeNode) {}
    fn visit_desc_edge(&mut self, _node: &DescEdgeNode) {}
    fn visit_drop_edge(&mut self, _node: &DropEdgeNode) {}
    fn visit_show_edges(&mut self, _node: &ShowEdgesNode) {}
    fn visit_create_tag_index(&mut self, _node: &CreateTagIndexNode) {}
    fn visit_drop_tag_index(&mut self, _node: &DropTagIndexNode) {}
    fn visit_desc_tag_index(&mut self, _node: &DescTagIndexNode) {}
    fn visit_show_tag_indexes(&mut self, _node: &ShowTagIndexesNode) {}
    fn visit_create_edge_index(&mut self, _node: &CreateEdgeIndexNode) {}
    fn visit_drop_edge_index(&mut self, _node: &DropEdgeIndexNode) {}
    fn visit_desc_edge_index(&mut self, _node: &DescEdgeIndexNode) {}
    fn visit_show_edge_indexes(&mut self, _node: &ShowEdgeIndexesNode) {}
    fn visit_rebuild_tag_index(&mut self, _node: &RebuildTagIndexNode) {}
    fn visit_rebuild_edge_index(&mut self, _node: &RebuildEdgeIndexNode) {}
}
