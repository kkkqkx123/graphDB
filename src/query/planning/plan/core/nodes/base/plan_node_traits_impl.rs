...
impl NodeType for PlanNodeEnum {
    fn node_type_id(&self) -> &'static str {
        match self {
            ...
            PlanNodeEnum::ShowCreateSpace(_) => "show_create_space",
            ...
            PlanNodeEnum::ShowCreateEdge(_) => "show_create_edge",
            ...
            PlanNodeEnum::ShowIndexes(_) => "show_indexes",
            PlanNodeEnum::ShowCreateIndex(_) => "show_create_index",
            ...
            PlanNodeEnum::ShowUsers(_) => "show_users",
            PlanNodeEnum::ShowRoles(_) => "show_roles",
    ...
    fn node_type_name(&self) -> &'static str {
        match self {
            ...
            PlanNodeEnum::ShowCreateSpace(_) => "Show Create Space",
            ...
            PlanNodeEnum::ShowCreateEdge(_) => "Show Create Edge",
            ...
            PlanNodeEnum::ShowIndexes(_) => "Show Indexes",
            PlanNodeEnum::ShowCreateIndex(_) => "Show Create Index",
            ...
            PlanNodeEnum::ShowUsers(_) => "Show Users",
            PlanNodeEnum::ShowRoles(_) => "Show Roles",
    ...
    fn category(&self) -> NodeCategory {
        match self {
            ...
            PlanNodeEnum::ShowCreateSpace(_) => NodeCategory::Admin,
            ...
            PlanNodeEnum::ShowCreateEdge(_) => NodeCategory::Admin,
            ...
            PlanNodeEnum::ShowIndexes(_) => NodeCategory::Admin,
            PlanNodeEnum::ShowCreateIndex(_) => NodeCategory::Admin,
            ...
            PlanNodeEnum::ShowUsers(_) => NodeCategory::Admin,
            PlanNodeEnum::ShowRoles(_) => NodeCategory::Admin,
...
impl NodeTypeMapping for PlanNodeEnum {
    fn corresponding_executor_type(&self) -> Option<&'static str> {
        match self {
            ...
            PlanNodeEnum::ShowCreateSpace(_) => Some("show_create_space"),
            ...
            PlanNodeEnum::ShowCreateEdge(_) => Some("show_create_edge"),
            ...
            PlanNodeEnum::ShowIndexes(_) => Some("show_indexes"),
            PlanNodeEnum::ShowCreateIndex(_) => Some("show_create_index"),
            ...
            PlanNodeEnum::ShowUsers(_) => Some("show_users"),
            PlanNodeEnum::ShowRoles(_) => Some("show_roles"),
