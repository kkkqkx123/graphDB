...
impl ExpressionValidationStrategy {
    ...
    pub fn validate_filter(
        ...
        // 简化验证：直接检查布尔常量
        match filter {
            Expression::Literal(crate::core::types::expression::LiteralValue::Bool(_)) => Ok(()),
...
mod tests {
    ...
    fn test_validate_filter() {
        ...
        // 测试布尔表达式
        let bool_expr =
            Expression::Literal(crate::core::types::expression::LiteralValue::Bool(true));
    ...
    fn test_validate_return() {
        ...
        // 测试Return子句验证
        let return_expr = Expression::Literal(crate::core::types::expression::LiteralValue::Int(1));
        assert!(strategy
    ...
    fn test_validate_with() {
        ...
        // 测试With子句验证
        let with_expr = Expression::Literal(crate::core::types::expression::LiteralValue::Int(1));
        assert!(strategy
    ...
    fn test_validate_unwind() {
        ...
        let unwind_context = UnwindClauseContext {
            ...
            unwind_expr: Expression::Literal(crate::core::types::expression::LiteralValue::Int(1)),
            aliases_available: std::collections::HashMap::new(),
            aliases_generated: std::collections::HashMap::new(),
            paths: Vec::new(),
        };
        ...
        // 测试Unwind子句验证
        let unwind_expr = Expression::Literal(crate::core::types::expression::LiteralValue::Int(1));
        assert!(strategy
    ...
    fn test_single_path_pattern() {
        ...
        // 测试单个路径模式验证
        let pattern = Expression::Literal(crate::core::types::expression::LiteralValue::Int(1));
        assert!(strategy
