...
impl StorageClient for DummyStorage {
    ...
    ) -> Result<Value, crate::core::StorageError> {
        Ok(Value::Int(0))
    }
    fn get_vertex(
        &self,
        _space: &str,
        _id: &Value,
    ) -> Result<Option<crate::core::Vertex>, crate::core::StorageError> {
        Ok(None)
    }
    fn update_vertex(
        &mut self,
    ...
    fn scan_vertices(
        &self,
        _space: &str,
    ) -> Result<Vec<crate::core::Vertex>, crate::core::StorageError> {
        Ok(Vec::new())
    }
    ...
    fn batch_insert_vertices(
        &mut self,
        _space: &str,
        _vertices: Vec<crate::core::Vertex>,
    ) -> Result<Vec<Value>, crate::core::StorageError> {
        Ok(Vec::new())
    }
    fn batch_insert_edges(
        &mut self,
        _space: &str,
        _edges: Vec<crate::core::Edge>,
    ) -> Result<(), crate::core::StorageError> {
        Ok(())
    }
    fn create_space(
    ...
    fn get_space(
        &self,
        _space: &str,
    ) -> Result<Option<crate::core::types::SpaceInfo>, crate::core::StorageError> {
        Ok(None)
    }
    fn get_space_by_id(
        &self,
    ...
    fn create_tag(
        &mut self,
        _space: &str,
        _info: &crate::core::types::TagInfo,
    ) -> Result<bool, crate::core::StorageError> {
        Ok(true)
    }
    fn alter_tag(
        ...
        _space: &str,
        _tag_name: &str,
        _additions: Vec<crate::core::types::PropertyDef>,
    ...
    fn get_tag(
        ...
        _space: &str,
        _tag_name: &str,
    ) -> Result<Option<crate::core::types::TagInfo>, crate::core::StorageError> {
        Ok(None)
    }
    fn drop_tag(
        &mut self,
    ...
    fn list_tags(
        &self,
        _space: &str,
    ) -> Result<Vec<crate::core::types::TagInfo>, crate::core::StorageError> {
        Ok(Vec::new())
    }
    fn create_edge_type(
        &mut self,
        _space: &str,
        _info: &crate::core::types::EdgeTypeSchema,
    ) -> Result<bool, crate::core::StorageError> {
        Ok(true)
    }
    fn alter_edge_type(
    ...
    fn get_edge_type(
        ...
        _space: &str,
        _edge_type_name: &str,
    ) -> Result<Option<crate::core::types::EdgeTypeSchema>, crate::core::StorageError> {
        Ok(None)
    }
    fn drop_edge_type(
        &mut self,
    ...
    fn list_edge_types(
        &self,
        _space: &str,
    ) -> Result<Vec<crate::core::types::EdgeTypeSchema>, crate::core::StorageError> {
        Ok(Vec::new())
    }
    fn create_tag_index(
        &mut self,
    ...
    fn change_password(
        &mut self,
        _info: &crate::core::types::PasswordInfo,
    ) -> Result<bool, crate::core::StorageError> {
        Ok(true)
    }
    ...
    fn insert_vertex_data(
        &mut self,
        _space: &str,
        _info: &crate::core::types::InsertVertexInfo,
    ) -> Result<bool, crate::core::StorageError> {
        Ok(true)
    }
    fn insert_edge_data(
        &mut self,
        _space: &str,
        _info: &crate::core::types::InsertEdgeInfo,
    ) -> Result<bool, crate::core::StorageError> {
        Ok(true)
    }
    ...
    fn update_data(
        &mut self,
        _space: &str,
        _info: &crate::core::types::UpdateInfo,
    ) -> Result<bool, crate::core::StorageError> {
        Ok(true)
    }
    ...
    ) -> Result<Option<(crate::storage::Schema, Vec<u8>)>, crate::core::StorageError> {
        Ok(None)
    }
    ...
    fn scan_vertices_with_schema(
        ...
        _space: &str,
        _tag_name: &str,
    ) -> Result<Vec<(crate::storage::Schema, Vec<u8>)>, crate::core::StorageError> {
        Ok(Vec::new())
    }
    ...
    ) -> Result<Vec<crate::core::Value>, crate::core::StorageError> {
        Ok(Vec::new())
    }
    ...
    fn lookup_index_with_score(
        ...
        _index: &str,
        _value: &crate::core::Value,
    ) -> Result<Vec<(crate::core::Value, f32)>, crate::core::StorageError> {
        Ok(Vec::new())
    }
