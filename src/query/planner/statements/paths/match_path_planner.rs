...
impl MatchPathPlanner {
    ...
    pub fn plan_path_pattern<S: StorageEngine>(
        &self,
        storage: &S,
        pattern: &PathPattern,
        space_id: i32,
    ...
    fn plan_simple_pattern<S: StorageEngine>(
        &self,
        storage: &S,
        start: &NodePattern,
        edge: &EdgePattern,
    ...
    fn plan_variable_length_pattern<S: StorageEngine>(
        &self,
        storage: &S,
        start: &NodePattern,
        edge: &EdgePattern,
    ...
    fn plan_start_finder<S: StorageEngine>(
        &self,
        _storage: &S,
        pattern: &NodePattern,
        space_id: i32,
