...
impl<S: StorageClient + Send + 'static> super::base::Executor<S> for ExecutorEnum<S> {
    async fn execute(&mut self) -> DBResult<ExecutionResult> {
        ...
        let result = match self {
            ...
            ExecutorEnum::FulltextIndexScan(exec) => exec.execute().await,
            ExecutorEnum::BFSShortest(exec) => exec.execute().await,
            ExecutorEnum::ShowSpaces(exec) => exec.execute().await,
            ExecutorEnum::ShowTags(exec) => exec.execute().await,
            ExecutorEnum::ShowEdges(exec) => exec.execute().await,
            ExecutorEnum::CreateTagIndex(exec) => exec.execute().await,
            ExecutorEnum::DropTagIndex(exec) => exec.execute().await,
            ExecutorEnum::DescTagIndex(exec) => exec.execute().await,
            ExecutorEnum::ShowTagIndexes(exec) => exec.execute().await,
            ExecutorEnum::RebuildTagIndex(exec) => exec.execute().await,
            ExecutorEnum::CreateEdgeIndex(exec) => exec.execute().await,
            ExecutorEnum::DropEdgeIndex(exec) => exec.execute().await,
            ExecutorEnum::DescEdgeIndex(exec) => exec.execute().await,
            ExecutorEnum::ShowEdgeIndexes(exec) => exec.execute().await,
            ExecutorEnum::RebuildEdgeIndex(exec) => exec.execute().await,
            ...
            ExecutorEnum::CreateUser(exec) => exec.execute().await,
            ExecutorEnum::AlterUser(exec) => exec.execute().await,
            ExecutorEnum::DropUser(exec) => exec.execute().await,
