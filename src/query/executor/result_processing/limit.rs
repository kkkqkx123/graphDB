...
#[async_trait]
impl<S: StorageEngine + Send + 'static> ExecutorCore for LimitExecutor<S> {
...
impl<S: StorageEngine + Send> ExecutorLifecycle for LimitExecutor<S> {
...
impl<S: StorageEngine + Send + 'static> HasStorage<S> for LimitExecutor<S> {
