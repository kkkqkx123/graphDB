...
impl<S: StorageClient> ShowEdgeIndexStatusExecutor<S> {
    pub fn new(id: i64, storage: Arc<Mutex<S>>, space_name: String, expr_context: Arc<ExpressionAnalysisContext>) -> Self {
        Self {
            base: BaseExecutor::new(id, "ShowEdgeIndexStatusExecutor".to_string(), storage, expr_context),
            space_name,
            index_name: None,
        }
    }
...
mod tests {
    ...
    fn test_show_edge_index_status_executor() {
        ...
        let mut executor = ShowEdgeIndexStatusExecutor::new(1, storage, "test_space".to_string(), expr_context);
    ...
    fn test_executor_lifecycle() {
        ...
        let expr_context = Arc::new(ExpressionAnalysisContext::new());
        let mut executor = ShowEdgeIndexStatusExecutor::new(3, storage, "test_space".to_string(), expr_context);
    ...
    fn test_executor_stats() {
        ...
        let expr_context = Arc::new(ExpressionAnalysisContext::new());
        let executor = ShowEdgeIndexStatusExecutor::new(4, storage, "test_space".to_string(), expr_context);
