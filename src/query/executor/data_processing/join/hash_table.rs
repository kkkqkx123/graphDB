...
mod tests {
    ...
    fn test_single_key_hash_table() {
        ...
        let hash_table = HashTableBuilder::build_single_key_table(&dataset, 0)
            .expect("Expected successful single key hash table build");
    ...
    fn test_multi_key_hash_table() {
        ...
        let hash_table = HashTableBuilder::build_multi_key_table(&dataset, &[0, 1])
            .expect("Expected successful multi key hash table build");
    ...
    fn test_hash_table_probe() {
        ...
        let hash_table = HashTableBuilder::build_single_key_table(&build_dataset, 0)
            .expect("Expected successful single key hash table build for probe test");
