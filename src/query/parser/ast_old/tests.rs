...
mod tests {
    ...
    fn test_function_call() {
        ...
        assert_eq!(func_expr.expr_type(), Expr::FunctionCall);
    ...
    fn test_case_expression() {
        ...
        assert_eq!(case_expr.expr_type(), Expr::Case);
    ...
    fn test_list_expression() {
        ...
        assert_eq!(list_expr.expr_type(), Expr::List);
    ...
    fn test_map_expression() {
        ...
        assert_eq!(map_expr.expr_type(), Expr::Map);
    ...
    fn test_predicate_expression() {
        ...
        assert_eq!(predicate_expr.expr_type(), Expr::Predicate);
    ...
    fn test_create_statement() {
        ...
        let create_stmt = CreateStmt::new(target, false, span);
        
        assert_eq!(create_stmt.stmt_type(), Stmt::Create);
    ...
    fn test_match_statement() {
        ...
        let patterns: Vec<Pattern> = vec![]; // 空模式用于测试
        let match_stmt = MatchStmt::new(patterns, span);
    ...
    fn test_go_statement() {
        ...
        assert_eq!(go_stmt.stmt_type(), Stmt::Go);
    ...
    fn test_node_pattern() {
        ...
        assert_eq!(node_pattern.pattern_type(), Pattern::Node);
    ...
    fn test_edge_pattern() {
        ...
        assert_eq!(edge_pattern.pattern_type(), Pattern::Edge);
    ...
    fn test_path_pattern() {
        ...
        assert_eq!(path_pattern.pattern_type(), Pattern::Path);
