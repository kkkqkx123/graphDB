...
pub mod types;
pub use types::{
    Label, MatchClause, MatchClause, MatchEdge, MatchNode, Pattern, PatternSegment,
...
// 显式导出语句类型
pub use statement::{
    Assignment, BaseStmt, CreateStmt, CreateTarget, DataType, DeleteStmt, DeleteTarget,
    EdgeDirection, ExplainStmt, FetchStatement, FetchTarget, FromClause, GoStatement,
    MatchStmt, OrderByClause, OverClause, PropertyRef, QueryStatement, ReturnClause, SetClause,
    ShowStmt, ShowTarget, Steps, UpdateStmt, UpdateTarget, UseStmt, YieldClause,
};
...
impl Query {
    ...
    pub fn single_statement(stmt: Stmt, span: Span) -> Self {
        Self {
            statements: vec![stmt],
            span,
        }
