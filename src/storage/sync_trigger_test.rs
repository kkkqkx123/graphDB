...
mod tests {
    ...
    use crate::core::types::{SpaceInfo, TagInfo, PropertyDef};
    ...
    fn test_storage_with_sync_manager() {
        ...
        assert!(storage.state().sync_manager.is_none(), "Sync manager should be None by default");
    ...
    fn test_vertex_insert_without_sync() {
        ...
        let tag_info = TagInfo::new("Person".to_string())
            .with_properties(vec![PropertyDef::new("name".to_string(), crate::core::types::DataType::String)]);
    ...
    fn test_vertex_update_without_sync() {
        ...
        assert_eq!(vertex.tags[0].properties.get("name"), Some(&Value::String("Bob".to_string())));
    }
