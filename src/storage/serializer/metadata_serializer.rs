...
pub fn space_to_bytes(space: &SpaceInfo) -> Result<Vec<u8>, StorageError> {
    encode_to_vec(space, standard()).map_err(|e| StorageError::SerializeError(e.to_string()))
}
...
pub fn tag_to_bytes(tag: &TagInfo) -> Result<Vec<u8>, StorageError> {
    encode_to_vec(tag, standard()).map_err(|e| StorageError::SerializeError(e.to_string()))
}
...
pub fn edge_type_to_bytes(edge_type: &EdgeTypeInfo) -> Result<Vec<u8>, StorageError> {
    encode_to_vec(edge_type, standard()).map_err(|e| StorageError::SerializeError(e.to_string()))
}
...
pub fn index_to_bytes(index: &Index) -> Result<Vec<u8>, StorageError> {
    encode_to_vec(index, standard()).map_err(|e| StorageError::SerializeError(e.to_string()))
}
