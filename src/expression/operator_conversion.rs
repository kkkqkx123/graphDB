...
) -> crate::core::types::expression::BinaryOperator {
    use crate::core::types::expression::BinaryOperator as GraphOp;
...
) -> crate::core::types::expression::UnaryOperator {
    use crate::core::types::expression::UnaryOperator as GraphOp;
